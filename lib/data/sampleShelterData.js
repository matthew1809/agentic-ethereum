export const shelterData = [
    {
        ...
        shelter_info: {
            name: { $share: 'Happy Paws Warsaw Shelter' },
            location: { $share: 'ul. Zwierzeca 12, 00-001 Warsaw' },
            operational_costs: { $share: 180000 }  // PLN
        },
        metrics: {
            current_animals: 5,
            monthly_intake: 12,
    ...
    },
    {
        ...
        shelter_info: {
            name: { $share: 'Krakow Animal Haven' },
            location: { $share: 'ul. Adopcyjna 45, 30-001 Krakow' },
            operational_costs: { $share: 220000 }
        },
        metrics: {
            current_animals: 6,
            monthly_intake: 15,
    ...
    },
    {
        ...
        shelter_info: {
            name: { $share: 'Guardian Angel Shelter Gdansk' },
            location: { $share: 'ul. Schroniskowa 8, 80-001 Gdansk' },
            operational_costs: { $share: 165000 }
        },
        metrics: {
            current_animals: 4,
            monthly_intake: 10,
    ...
    },
    {
        ...
        shelter_info: {
            name: { $share: 'Poznan Foster Home' },
            location: { $share: 'ul. Kocich Lapek 23, 60-001 Poznan' },
            operational_costs: { $share: 195000 }
        },
        metrics: {
            current_animals: 3,
            monthly_intake: 18,
    ...
    },
    {
        ...
        shelter_info: {
            name: { $share: 'Wroclaw Paws & Whiskers' },
            location: { $share: 'ul. Przyjazna 56, 50-001 Wroclaw' },
            operational_costs: { $share: 175000 }
        },
        metrics: {
            current_animals: 4,
            monthly_intake: 14,
    ...
    },
    {
        ...
        shelter_info: {
            name: { $share: 'Lodz Animal Sanctuary' },
            location: { $share: 'ul. Zwierzat 34, 90-001 Lodz' },
            operational_costs: { $share: 168000 }
        },
        metrics: {
            current_animals: 5,
            monthly_intake: 8,
